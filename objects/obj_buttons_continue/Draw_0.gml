...
if menu = 3
{
	...
	draw_text(x, y + 20, "Cancel - " + obj_title.cancel_key)
	...
	draw_text(x, y + 40,"Sprint - Shift / " + obj_title.sprint_key)
	...
	draw_text(x, y + 60,"Menu - " + obj_title.menu_key)
	...
	draw_text(x, y + 80,"Up - Up Arrow / " + obj_title.up_key)
	...
	draw_text(x, y + 100,"Down - Down Arrow / " + obj_title.down_key)
	...
	draw_text(x, y + 120,"Left - Left Arrow / " + obj_title.left_key)
	...
	draw_text(x, y + 140,"Right - Right Arrow / " + obj_title.right_key)
}
